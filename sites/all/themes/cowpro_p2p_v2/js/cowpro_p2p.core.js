...
jQuery(document).ready(function($){
    ...
    {  
     ...
     strHtml += " <li style=\"background:#fff;text-align:center;font-size:12px;height:120px;line-height:100px;border-left:1px solid #FFB226;border-right:1px solid #F9CADE;\">"+str+"</li>\n";  
